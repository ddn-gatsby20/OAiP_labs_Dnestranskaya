...
Лабораторная раюота №5
Вариант №10
Задание:написать программу, которая записывает с клавиатуры файл структуру согласно выданному варианту задания.
В программе реализовать: дополнение существующего массива структур новыми структурами, поиск структуры с заданным значением выбранного элемента,
вывод на экран содержимого массива структур,упорядочение массива структур по заданному полю
Вариант задания: "Государство":название страны,столица,язык,население, площадь территории,денежная единица,государственный строй
*/
